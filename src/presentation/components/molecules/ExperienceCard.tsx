...
export function ExperienceCard({ experience }: ExperienceCardProps) {
  return (
    <article className="rounded-3xl border border-foreground/10 bg-background/80 p-6 shadow-sm backdrop-blur">
          ...
          <Text variant="muted" className="mt-1 space-x-2">
            ...
            {experience.website && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="text-xs uppercase tracking-wide text-foreground/60 underline underline-offset-4 hover:text-foreground/80"
              >
                Sitio
              </a>
            )}
